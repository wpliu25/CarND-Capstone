...
#define __PYX_HAVE__light_classification__darkflow__cython_utils__nms
#define __PYX_HAVE_API__light_classification__darkflow__cython_utils__nms
#include <string.h>
#include <stdio.h>
...
/* "light_classification/darkflow/cython_utils/nms.pxd":4
 * cimport numpy as np
 * cimport cython
...
static float __pyx_f_20light_classification_8darkflow_12cython_utils_3nms_overlap_c(float, float, float, float); /*proto*/
static float __pyx_f_20light_classification_8darkflow_12cython_utils_3nms_box_intersection_c(float, float, float, float, float, float, float, float); /*proto*/
static float __pyx_f_20light_classification_8darkflow_12cython_utils_3nms_box_union_c(float, float, float, float, float, float, float, float); /*proto*/
static float __pyx_f_20light_classification_8darkflow_12cython_utils_3nms_box_iou_c(float, float, float, float, float, float, float, float); /*proto*/
...
#define __Pyx_MODULE_NAME "light_classification.darkflow.cython_utils.nms"
extern int __pyx_module_is_main_light_classification__darkflow__cython_utils__nms;
int __pyx_module_is_main_light_classification__darkflow__cython_utils__nms = 0;

/* Implementation of 'light_classification.darkflow.cython_utils.nms' */
...
/* "light_classification/darkflow/cython_utils/nms.pyx":13
...
static float __pyx_f_20light_classification_8darkflow_12cython_utils_3nms_overlap_c(float __pyx_v_x1, float __pyx_v_w1, float __pyx_v_x2, float __pyx_v_w2) {
  float __pyx_v_l1;
  float __pyx_v_l2;
  float __pyx_v_left;
  float __pyx_v_right;
  ...
  /* "light_classification/darkflow/cython_utils/nms.pyx":16
 *     cdef:
 *         float l1,l2,left,right
 *     l1 = x1 - w1 /2.             # <<<<<<<<<<<<<<
 *     l2 = x2 - w2 /2.
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/nms.pyx":17
 *         float l1,l2,left,right
 *     l1 = x1 - w1 /2.
 *     l2 = x2 - w2 /2.             # <<<<<<<<<<<<<<
 *     left = max(l1,l2)
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/nms.pyx":18
 *     l1 = x1 - w1 /2.
 *     l2 = x2 - w2 /2.
 *     left = max(l1,l2)             # <<<<<<<<<<<<<<
 *     r1 = x1 + w1 /2.
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/nms.pyx":19
 *     l2 = x2 - w2 /2.
 *     left = max(l1,l2)
 *     r1 = x1 + w1 /2.             # <<<<<<<<<<<<<<
 *     r2 = x2 + w2 /2.
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/nms.pyx":20
 *     left = max(l1,l2)
 *     r1 = x1 + w1 /2.
 *     r2 = x2 + w2 /2.             # <<<<<<<<<<<<<<
 *     right = min(r1, r2)
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/nms.pyx":21
 *     r1 = x1 + w1 /2.
 *     r2 = x2 + w2 /2.
 *     right = min(r1, r2)             # <<<<<<<<<<<<<<
 *     return right - left;
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/nms.pyx":22
 *     r2 = x2 + w2 /2.
 *     right = min(r1, r2)
 *     return right - left;             # <<<<<<<<<<<<<<
 * 
...
/* "light_classification/darkflow/cython_utils/nms.pyx":28
 * @cython.wraparound(False)  # turn off negative index wrapping for entire function
 * @cython.cdivision(True)
...
static float __pyx_f_20light_classification_8darkflow_12cython_utils_3nms_box_intersection_c(float __pyx_v_ax, float __pyx_v_ay, float __pyx_v_aw, float __pyx_v_ah, float __pyx_v_bx, float __pyx_v_by, float __pyx_v_bw, float __pyx_v_bh) {
  float __pyx_v_w;
  float __pyx_v_h;
  float __pyx_v_area;
  float __pyx_r;
  ...
  /* "light_classification/darkflow/cython_utils/nms.pyx":31
 *     cdef:
 *         float w,h,area
 ...
 */
  __pyx_v_w = __pyx_f_20light_classification_8darkflow_12cython_utils_3nms_overlap_c(__pyx_v_ax, __pyx_v_aw, __pyx_v_bx, __pyx_v_bw);

  /* "light_classification/darkflow/cython_utils/nms.pyx":32
 *         float w,h,area
 *     w = overlap_c(ax, aw, bx, bw)
 *     h = overlap_c(ay, ah, by, bh)             # <<<<<<<<<<<<<<
 *     if w < 0 or h < 0: return 0
 *     area = w * h
 */
  __pyx_v_h = __pyx_f_20light_classification_8darkflow_12cython_utils_3nms_overlap_c(__pyx_v_ay, __pyx_v_ah, __pyx_v_by, __pyx_v_bh);

  /* "light_classification/darkflow/cython_utils/nms.pyx":33
 *     w = overlap_c(ax, aw, bx, bw)
 *     h = overlap_c(ay, ah, by, bh)
 *     if w < 0 or h < 0: return 0             # <<<<<<<<<<<<<<
 *     area = w * h
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/nms.pyx":34
 *     h = overlap_c(ay, ah, by, bh)
 *     if w < 0 or h < 0: return 0
 *     area = w * h             # <<<<<<<<<<<<<<
 *     return area
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/nms.pyx":35
 *     if w < 0 or h < 0: return 0
 *     area = w * h
 *     return area             # <<<<<<<<<<<<<<
 * 
...
/* "light_classification/darkflow/cython_utils/nms.pyx":41
 * @cython.wraparound(False)  # turn off negative index wrapping for entire function
 * @cython.cdivision(True)
...
static float __pyx_f_20light_classification_8darkflow_12cython_utils_3nms_box_union_c(float __pyx_v_ax, float __pyx_v_ay, float __pyx_v_aw, float __pyx_v_ah, float __pyx_v_bx, float __pyx_v_by, float __pyx_v_bw, float __pyx_v_bh) {
  float __pyx_v_i;
  float __pyx_v_u;
  float __pyx_r;
  __Pyx_RefNannyDeclarations
  ...
  /* "light_classification/darkflow/cython_utils/nms.pyx":44
 *     cdef:
 *         float i,u
 ...
 *     return u
 */
  __pyx_v_i = __pyx_f_20light_classification_8darkflow_12cython_utils_3nms_box_intersection_c(__pyx_v_ax, __pyx_v_ay, __pyx_v_aw, __pyx_v_ah, __pyx_v_bx, __pyx_v_by, __pyx_v_bw, __pyx_v_bh);

  /* "light_classification/darkflow/cython_utils/nms.pyx":45
 *         float i,u
 *     i = box_intersection_c(ax, ay, aw, ah, bx, by, bw, bh)
 *     u = aw * ah + bw * bh -i             # <<<<<<<<<<<<<<
 *     return u
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/nms.pyx":46
 *     i = box_intersection_c(ax, ay, aw, ah, bx, by, bw, bh)
 *     u = aw * ah + bw * bh -i
 *     return u             # <<<<<<<<<<<<<<
 * 
...
/* "light_classification/darkflow/cython_utils/nms.pyx":53
 * @cython.wraparound(False)  # turn off negative index wrapping for entire function
 * @cython.cdivision(True)
...
static float __pyx_f_20light_classification_8darkflow_12cython_utils_3nms_box_iou_c(float __pyx_v_ax, float __pyx_v_ay, float __pyx_v_aw, float __pyx_v_ah, float __pyx_v_bx, float __pyx_v_by, float __pyx_v_bw, float __pyx_v_bh) {
  float __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("box_iou_c", 0);

  /* "light_classification/darkflow/cython_utils/nms.pyx":54
 * @cython.cdivision(True)
 * cdef float box_iou_c(float ax, float ay, float aw, float ah, float bx, float by, float bw, float bh):
 *     return box_intersection_c(ax, ay, aw, ah, bx, by, bw, bh) / box_union_c(ax, ay, aw, ah, bx, by, bw, bh);             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_r = (__pyx_f_20light_classification_8darkflow_12cython_utils_3nms_box_intersection_c(__pyx_v_ax, __pyx_v_ay, __pyx_v_aw, __pyx_v_ah, __pyx_v_bx, __pyx_v_by, __pyx_v_bw, __pyx_v_bh) / __pyx_f_20light_classification_8darkflow_12cython_utils_3nms_box_union_c(__pyx_v_ax, __pyx_v_ay, __pyx_v_aw, __pyx_v_ah, __pyx_v_bx, __pyx_v_by, __pyx_v_bw, __pyx_v_bh));
  goto __pyx_L0;
...
/* "light_classification/darkflow/cython_utils/nms.pyx":63
 * @cython.wraparound(False)  # turn off negative index wrapping for entire function
 * @cython.cdivision(True)
...
static PyObject *__pyx_f_20light_classification_8darkflow_12cython_utils_3nms_NMS(__Pyx_memviewslice __pyx_v_final_probs, __Pyx_memviewslice __pyx_v_final_bbox) {
  ...
  /* "light_classification/darkflow/cython_utils/nms.pyx":64
 * @cython.cdivision(True)
 * cdef NMS(float[:, ::1] final_probs , float[:, ::1] final_bbox):
 *     cdef list boxes = list()             # <<<<<<<<<<<<<<
 *     cdef set indices = set()
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/nms.pyx":65
 * cdef NMS(float[:, ::1] final_probs , float[:, ::1] final_bbox):
 *     cdef list boxes = list()
 *     cdef set indices = set()             # <<<<<<<<<<<<<<
 *     cdef:
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/nms.pyx":70
 * 
 * 
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/nms.pyx":71
 * 
 *     pred_length = final_bbox.shape[0]
 *     class_length = final_probs.shape[1]             # <<<<<<<<<<<<<<
 *     for class_loop in range(class_length):
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/nms.pyx":72
 *     pred_length = final_bbox.shape[0]
 *     class_length = final_probs.shape[1]
 *     for class_loop in range(class_length):             # <<<<<<<<<<<<<<
 *         for index in range(pred_length):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "light_classification/darkflow/cython_utils/nms.pyx":73
 *     class_length = final_probs.shape[1]
 *     for class_loop in range(class_length):
 *         for index in range(pred_length):             # <<<<<<<<<<<<<<
 *             if final_probs[index,class_loop] == 0: continue
 ...
 */
    ...
    for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
      ...
      /* "light_classification/darkflow/cython_utils/nms.pyx":74
 *     for class_loop in range(class_length):
 *         for index in range(pred_length):
 *             if final_probs[index,class_loop] == 0: continue             # <<<<<<<<<<<<<<
 *             for index2 in range(index+1,pred_length):
 ...
 */
      ...
      /* "light_classification/darkflow/cython_utils/nms.pyx":75
 *         for index in range(pred_length):
 *             if final_probs[index,class_loop] == 0: continue
 *             for index2 in range(index+1,pred_length):             # <<<<<<<<<<<<<<
 *                 if final_probs[index2,class_loop] == 0: continue
 ...
 */
      ...
      for (__pyx_t_10 = (__pyx_v_index + 1); __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
        ...
        /* "light_classification/darkflow/cython_utils/nms.pyx":76
 *             if final_probs[index,class_loop] == 0: continue
 *             for index2 in range(index+1,pred_length):
 *                 if final_probs[index2,class_loop] == 0: continue             # <<<<<<<<<<<<<<
 *                 if index==index2 : continue
 ...
 */
        ...
        /* "light_classification/darkflow/cython_utils/nms.pyx":77
 *             for index2 in range(index+1,pred_length):
 *                 if final_probs[index2,class_loop] == 0: continue
 *                 if index==index2 : continue             # <<<<<<<<<<<<<<
 *                 if box_iou_c(final_bbox[index,0],final_bbox[index,1],final_bbox[index,2],final_bbox[index,3],final_bbox[index2,0],final_bbox[index2,1],final_bbox[index2,2],final_bbox[index2,3]) >= 0.4:
 ...
 */
        ...
        /* "light_classification/darkflow/cython_utils/nms.pyx":78
 *                 if final_probs[index2,class_loop] == 0: continue
 *                 if index==index2 : continue
 *                 if box_iou_c(final_bbox[index,0],final_bbox[index,1],final_bbox[index,2],final_bbox[index,3],final_bbox[index2,0],final_bbox[index2,1],final_bbox[index2,2],final_bbox[index2,3]) >= 0.4:             # <<<<<<<<<<<<<<
 *                     if final_probs[index2,class_loop] > final_probs[index, class_loop] :
 ...
 */
          ...
          if (__pyx_t_8) {
            ...
            /* "light_classification/darkflow/cython_utils/nms.pyx":80
 *                 if box_iou_c(final_bbox[index,0],final_bbox[index,1],final_bbox[index,2],final_bbox[index,3],final_bbox[index2,0],final_bbox[index2,1],final_bbox[index2,2],final_bbox[index2,3]) >= 0.4:
 *                     if final_probs[index2,class_loop] > final_probs[index, class_loop] :
 *                         final_probs[index, class_loop] =0             # <<<<<<<<<<<<<<
 *                         break
 ...
 */
            ...
            *((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_final_probs.data + __pyx_t_33 * __pyx_v_final_probs.strides[0]) )) + __pyx_t_34)) )) = 0.0;
            ...
            /* "light_classification/darkflow/cython_utils/nms.pyx":81
 *                     if final_probs[index2,class_loop] > final_probs[index, class_loop] :
 *                         final_probs[index, class_loop] =0
 *                         break             # <<<<<<<<<<<<<<
 *                     final_probs[index2,class_loop]=0
 ...
 */
          ...
          /* "light_classification/darkflow/cython_utils/nms.pyx":82
 *                         final_probs[index, class_loop] =0
 *                         break
 *                     final_probs[index2,class_loop]=0             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "light_classification/darkflow/cython_utils/nms.pyx":84
 *                     final_probs[index2,class_loop]=0
 * 
 *             if index not in indices:             # <<<<<<<<<<<<<<
 ...
 */
      ...
      if (__pyx_t_37) {
        ...
        /* "light_classification/darkflow/cython_utils/nms.pyx":85
 * 
 *             if index not in indices:
 *                 bb=BoundBox(class_length)             # <<<<<<<<<<<<<<
 *                 bb.x = final_bbox[index, 0]
 ...
 */
        ...
        /* "light_classification/darkflow/cython_utils/nms.pyx":86
 *             if index not in indices:
 *                 bb=BoundBox(class_length)
 *                 bb.x = final_bbox[index, 0]             # <<<<<<<<<<<<<<
 *                 bb.y = final_bbox[index, 1]
 ...
 */
        ...
        /* "light_classification/darkflow/cython_utils/nms.pyx":87
 *                 bb=BoundBox(class_length)
 *                 bb.x = final_bbox[index, 0]
 *                 bb.y = final_bbox[index, 1]             # <<<<<<<<<<<<<<
 *                 bb.w = final_bbox[index, 2]
 ...
 */
        ...
        /* "light_classification/darkflow/cython_utils/nms.pyx":88
 *                 bb.x = final_bbox[index, 0]
 *                 bb.y = final_bbox[index, 1]
 *                 bb.w = final_bbox[index, 2]             # <<<<<<<<<<<<<<
 *                 bb.h = final_bbox[index, 3]
 ...
 */
        ...
        /* "light_classification/darkflow/cython_utils/nms.pyx":89
 *                 bb.y = final_bbox[index, 1]
 *                 bb.w = final_bbox[index, 2]
 *                 bb.h = final_bbox[index, 3]             # <<<<<<<<<<<<<<
 *                 bb.c = final_bbox[index, 4]
 ...
 */
        ...
        /* "light_classification/darkflow/cython_utils/nms.pyx":90
 *                 bb.w = final_bbox[index, 2]
 *                 bb.h = final_bbox[index, 3]
 *                 bb.c = final_bbox[index, 4]             # <<<<<<<<<<<<<<
 *                 bb.probs = np.asarray(final_probs[index,:])
 ...
 */
        ...
        /* "light_classification/darkflow/cython_utils/nms.pyx":91
 *                 bb.h = final_bbox[index, 3]
 *                 bb.c = final_bbox[index, 4]
 *                 bb.probs = np.asarray(final_probs[index,:])             # <<<<<<<<<<<<<<
 *                 boxes.append(bb)
...
__pyx_t_38 = __pyx_memoryview_fromslice(__pyx_t_52, 1, (PyObject *(*)(char *)) __pyx_memview_get_float, (int (*)(char *, PyObject *)) __pyx_memview_set_float, 0);; if (unlikely(!__pyx_t_38)) __PYX_ERR(0, 91, __pyx_L1_error)
        ...
        /* "light_classification/darkflow/cython_utils/nms.pyx":92
 *                 bb.c = final_bbox[index, 4]
 *                 bb.probs = np.asarray(final_probs[index,:])
 *                 boxes.append(bb)             # <<<<<<<<<<<<<<
 *                 indices.add(index)
 ...
 */
        ...
        /* "light_classification/darkflow/cython_utils/nms.pyx":93
 *                 bb.probs = np.asarray(final_probs[index,:])
 *                 boxes.append(bb)
 *                 indices.add(index)             # <<<<<<<<<<<<<<
 *     return boxes
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/nms.pyx":94
 *                 boxes.append(bb)
 *                 indices.add(index)
 *     return boxes             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_t_52, 1);
  __Pyx_AddTraceback("light_classification.darkflow.cython_utils.nms.NMS", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "light_classification.darkflow.cython_utils.nms.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "light_classification.darkflow.cython_utils.nms.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "light_classification.darkflow.cython_utils.nms.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "light_classification.darkflow.cython_utils.nms._memoryviewslice", /*tp_name*/
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_light_classification__darkflow__cython_utils__nms) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "light_classification.darkflow.cython_utils.nms")) {
      if (unlikely(PyDict_SetItemString(modules, "light_classification.darkflow.cython_utils.nms", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("NMS", (void (*)(void))__pyx_f_20light_classification_8darkflow_12cython_utils_3nms_NMS, "PyObject *(__Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  /*--- Type init code ---*/
  ...
  /* "light_classification/darkflow/cython_utils/nms.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * cimport cython
 */
  ...
  /* "light_classification/darkflow/cython_utils/nms.pyx":5
 * cimport cython
 * from libc.math cimport exp
 * from ..utils.box import BoundBox             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init light_classification.darkflow.cython_utils.nms", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init light_classification.darkflow.cython_utils.nms");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
