...
#define __PYX_HAVE__light_classification__darkflow__cython_utils__cy_yolo_findboxes
#define __PYX_HAVE_API__light_classification__darkflow__cython_utils__cy_yolo_findboxes
#include <string.h>
#include <stdio.h>
...
/* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":4
 * cimport numpy as np
 * cimport cython
 * ctypedef np.float_t DTYPE_t             # <<<<<<<<<<<<<<
 * from libc.math cimport exp
 * from ..utils.box import BoundBox
 */
typedef __pyx_t_5numpy_float_t __pyx_t_20light_classification_8darkflow_12cython_utils_17cy_yolo_findboxes_DTYPE_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'light_classification.darkflow.cython_utils.cy_yolo_findboxes' */
...
#define __Pyx_MODULE_NAME "light_classification.darkflow.cython_utils.cy_yolo_findboxes"
extern int __pyx_module_is_main_light_classification__darkflow__cython_utils__cy_yolo_findboxes;
int __pyx_module_is_main_light_classification__darkflow__cython_utils__cy_yolo_findboxes = 0;

/* Implementation of 'light_classification.darkflow.cython_utils.cy_yolo_findboxes' */
...
static const char __pyx_k_light_classification_darkflow_cy[] = "light_classification.darkflow.cython_utils.cy_yolo_findboxes";
...
static PyObject *__pyx_pf_20light_classification_8darkflow_12cython_utils_17cy_yolo_findboxes_yolo_box_constructor(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_meta, PyArrayObject *__pyx_v_net_out, float __pyx_v_threshold); /* proto */
...
/* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":14
...
/* Python wrapper */
static PyObject *__pyx_pw_20light_classification_8darkflow_12cython_utils_17cy_yolo_findboxes_1yolo_box_constructor(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_20light_classification_8darkflow_12cython_utils_17cy_yolo_findboxes_1yolo_box_constructor = {"yolo_box_constructor", (PyCFunction)__pyx_pw_20light_classification_8darkflow_12cython_utils_17cy_yolo_findboxes_1yolo_box_constructor, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_20light_classification_8darkflow_12cython_utils_17cy_yolo_findboxes_1yolo_box_constructor(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("light_classification.darkflow.cython_utils.cy_yolo_findboxes.yolo_box_constructor", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __pyx_r = __pyx_pf_20light_classification_8darkflow_12cython_utils_17cy_yolo_findboxes_yolo_box_constructor(__pyx_self, __pyx_v_meta, __pyx_v_net_out, __pyx_v_threshold);
...
static PyObject *__pyx_pf_20light_classification_8darkflow_12cython_utils_17cy_yolo_findboxes_yolo_box_constructor(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_meta, PyArrayObject *__pyx_v_net_out, float __pyx_v_threshold) {
  float __pyx_v_sqrt;
  int __pyx_v_C;
  int __pyx_v_B;
  int __pyx_v_S;
  ...
  /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":24
 * 
 * 
 *     sqrt =  meta['sqrt'] + 1             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":25
 * 
 *     sqrt =  meta['sqrt'] + 1
 *     C, B, S = meta['classes'], meta['num'], meta['side']             # <<<<<<<<<<<<<<
 *     boxes = []
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":26
 *     sqrt =  meta['sqrt'] + 1
 *     C, B, S = meta['classes'], meta['num'], meta['side']
 *     boxes = []             # <<<<<<<<<<<<<<
 *     SS        =  S * S # number of grid cells
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":27
 *     C, B, S = meta['classes'], meta['num'], meta['side']
 *     boxes = []
 *     SS        =  S * S # number of grid cells             # <<<<<<<<<<<<<<
 *     prob_size = SS * C # class probabilities
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":28
 *     boxes = []
 *     SS        =  S * S # number of grid cells
 *     prob_size = SS * C # class probabilities             # <<<<<<<<<<<<<<
 *     conf_size = SS * B # confidences for each grid cell
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":29
 *     SS        =  S * S # number of grid cells
 *     prob_size = SS * C # class probabilities
 *     conf_size = SS * B # confidences for each grid cell             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":32
 * 
 *     cdef:
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":33
 *     cdef:
 *         float [:,::1] probs =  np.ascontiguousarray(net_out[0 : prob_size]).reshape([SS,C])
 *         float [:,::1] confs =  np.ascontiguousarray(net_out[prob_size : (prob_size + conf_size)]).reshape([SS,B])             # <<<<<<<<<<<<<<
 *         float [: , : ,::1] coords =  np.ascontiguousarray(net_out[(prob_size + conf_size) : ]).reshape([SS, B, 4])
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":34
 *         float [:,::1] probs =  np.ascontiguousarray(net_out[0 : prob_size]).reshape([SS,C])
 *         float [:,::1] confs =  np.ascontiguousarray(net_out[prob_size : (prob_size + conf_size)]).reshape([SS,B])
 *         float [: , : ,::1] coords =  np.ascontiguousarray(net_out[(prob_size + conf_size) : ]).reshape([SS, B, 4])             # <<<<<<<<<<<<<<
 *         float [:,:,::1] final_probs = np.zeros([SS,B,C],dtype=np.float32)
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":35
 *         float [:,::1] confs =  np.ascontiguousarray(net_out[prob_size : (prob_size + conf_size)]).reshape([SS,B])
 *         float [: , : ,::1] coords =  np.ascontiguousarray(net_out[(prob_size + conf_size) : ]).reshape([SS, B, 4])
 *         float [:,:,::1] final_probs = np.zeros([SS,B,C],dtype=np.float32)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":38
 * 
 * 
 ...
 */
  ...
  for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_6; __pyx_t_5+=1) {
    ...
    /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":39
 * 
 *     for grid in range(SS):
 *         for b in range(B):             # <<<<<<<<<<<<<<
 *             coords[grid, b, 0] = (coords[grid, b, 0] + grid %  S) / S
 ...
 */
    ...
    for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_4; __pyx_t_13+=1) {
      ...
      /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":40
 *     for grid in range(SS):
 *         for b in range(B):
 *             coords[grid, b, 0] = (coords[grid, b, 0] + grid %  S) / S             # <<<<<<<<<<<<<<
 *             coords[grid, b, 1] = (coords[grid, b, 1] + grid // S) / S
 ...
 */
      ...
      *((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_17 * __pyx_v_coords.strides[0]) ) + __pyx_t_18 * __pyx_v_coords.strides[1]) )) + __pyx_t_19)) )) = (((*((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_14 * __pyx_v_coords.strides[0]) ) + __pyx_t_15 * __pyx_v_coords.strides[1]) )) + __pyx_t_16)) ))) + (__pyx_v_grid % __pyx_v_S)) / __pyx_v_S);
      ...
      /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":41
 *         for b in range(B):
 *             coords[grid, b, 0] = (coords[grid, b, 0] + grid %  S) / S
 *             coords[grid, b, 1] = (coords[grid, b, 1] + grid // S) / S             # <<<<<<<<<<<<<<
 *             coords[grid, b, 2] =  coords[grid, b, 2] ** sqrt
 ...
 */
      ...
      *((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_23 * __pyx_v_coords.strides[0]) ) + __pyx_t_24 * __pyx_v_coords.strides[1]) )) + __pyx_t_25)) )) = (((*((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_20 * __pyx_v_coords.strides[0]) ) + __pyx_t_21 * __pyx_v_coords.strides[1]) )) + __pyx_t_22)) ))) + (__pyx_v_grid / __pyx_v_S)) / __pyx_v_S);
      ...
      /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":42
 *             coords[grid, b, 0] = (coords[grid, b, 0] + grid %  S) / S
 *             coords[grid, b, 1] = (coords[grid, b, 1] + grid // S) / S
 *             coords[grid, b, 2] =  coords[grid, b, 2] ** sqrt             # <<<<<<<<<<<<<<
 *             coords[grid, b, 3] =  coords[grid, b, 3] ** sqrt
 ...
 */
      ...
      *((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_29 * __pyx_v_coords.strides[0]) ) + __pyx_t_30 * __pyx_v_coords.strides[1]) )) + __pyx_t_31)) )) = powf((*((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_26 * __pyx_v_coords.strides[0]) ) + __pyx_t_27 * __pyx_v_coords.strides[1]) )) + __pyx_t_28)) ))), __pyx_v_sqrt);
      ...
      /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":43
 *             coords[grid, b, 1] = (coords[grid, b, 1] + grid // S) / S
 *             coords[grid, b, 2] =  coords[grid, b, 2] ** sqrt
 *             coords[grid, b, 3] =  coords[grid, b, 3] ** sqrt             # <<<<<<<<<<<<<<
 *             for class_loop in range(C):
 ...
 */
      ...
      *((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_35 * __pyx_v_coords.strides[0]) ) + __pyx_t_36 * __pyx_v_coords.strides[1]) )) + __pyx_t_37)) )) = powf((*((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_32 * __pyx_v_coords.strides[0]) ) + __pyx_t_33 * __pyx_v_coords.strides[1]) )) + __pyx_t_34)) ))), __pyx_v_sqrt);
      ...
      /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":44
 *             coords[grid, b, 2] =  coords[grid, b, 2] ** sqrt
 *             coords[grid, b, 3] =  coords[grid, b, 3] ** sqrt
 *             for class_loop in range(C):             # <<<<<<<<<<<<<<
 *                 probs[grid, class_loop] = probs[grid, class_loop] * confs[grid, b]
 ...
 */
      ...
      for (__pyx_t_39 = 0; __pyx_t_39 < __pyx_t_38; __pyx_t_39+=1) {
        ...
        /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":45
 *             coords[grid, b, 3] =  coords[grid, b, 3] ** sqrt
 *             for class_loop in range(C):
 *                 probs[grid, class_loop] = probs[grid, class_loop] * confs[grid, b]             # <<<<<<<<<<<<<<
 *                 #print("PROBS",probs[grid,class_loop])
 ...
 */
        ...
        *((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_probs.data + __pyx_t_44 * __pyx_v_probs.strides[0]) )) + __pyx_t_45)) )) = ((*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_probs.data + __pyx_t_40 * __pyx_v_probs.strides[0]) )) + __pyx_t_41)) ))) * (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_confs.data + __pyx_t_42 * __pyx_v_confs.strides[0]) )) + __pyx_t_43)) ))));
        ...
        /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":47
 *                 probs[grid, class_loop] = probs[grid, class_loop] * confs[grid, b]
 *                 #print("PROBS",probs[grid,class_loop])
 *                 if(probs[grid,class_loop] > threshold ):             # <<<<<<<<<<<<<<
 ...
 */
        ...
        if (__pyx_t_48) {
          ...
          /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":48
 *                 #print("PROBS",probs[grid,class_loop])
 *                 if(probs[grid,class_loop] > threshold ):
 *                     final_probs[grid, b, class_loop] = probs[grid, class_loop]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":51
 * 
 * 
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __pyx_f_20light_classification_8darkflow_12cython_utils_3nms_NMS(__pyx_t_11, __pyx_t_54); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "light_classification.darkflow.cython_utils.cy_yolo_findboxes.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "light_classification.darkflow.cython_utils.cy_yolo_findboxes.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "light_classification.darkflow.cython_utils.cy_yolo_findboxes.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "light_classification.darkflow.cython_utils.cy_yolo_findboxes._memoryviewslice", /*tp_name*/
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_light_classification__darkflow__cython_utils__cy_yolo_findboxes) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "light_classification.darkflow.cython_utils.cy_yolo_findboxes")) {
      if (unlikely(PyDict_SetItemString(modules, "light_classification.darkflow.cython_utils.cy_yolo_findboxes", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * cimport cython
 */
  ...
  /* "light_classification/darkflow/cython_utils/cy_yolo_findboxes.pyx":6
 * ctypedef np.float_t DTYPE_t
 * from libc.math cimport exp
 * from ..utils.box import BoundBox             # <<<<<<<<<<<<<<
 ...
 *     cdef:
 */
  __pyx_t_3 = PyCFunction_NewEx(&__pyx_mdef_20light_classification_8darkflow_12cython_utils_17cy_yolo_findboxes_1yolo_box_constructor, NULL, __pyx_n_s_light_classification_darkflow_cy); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init light_classification.darkflow.cython_utils.cy_yolo_findboxes", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init light_classification.darkflow.cython_utils.cy_yolo_findboxes");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
